...
-- 插件名：edgy 侧边栏
	...
	local edgy_ok, edgy_editor = pcall(require, "edgy.editor")
	if edgy_ok then
		local orig_check_main = edgy_editor.check_main
		edgy_editor.check_main = function()
			vim.schedule(orig_check_main)
		end
	end
