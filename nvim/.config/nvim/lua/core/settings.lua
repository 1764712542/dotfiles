...
settings["disabled_plugins"] = {
	-- cursor animation (keep smear-cursor + SmoothCursor only)
...
-- Valid options: `tokyonight`, `tokyonight-storm`, `tokyonight-night`, `tokyonight-moon`.
---@type string
...
settings["chat_models"] = {
	-- free models (2026-05 可用)
	"openrouter/free", -- default: 自动选择可用免费模型
